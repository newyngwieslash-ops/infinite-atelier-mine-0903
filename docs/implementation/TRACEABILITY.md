...
| AC-MIG / AC-COMPAT | Not started | WP-04, using fixtures named in `REPO_AUDIT.md`. |
...
| AC-BACKUP / AC-RELEASE / final hardening | Not started; legacy backup unsafe | WP-12, with secret exclusion begun in WP-02. |
